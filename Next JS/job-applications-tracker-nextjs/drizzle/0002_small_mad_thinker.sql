...
--> statement-breakpoint
DROP INDEX "applications_status_interview_date_idx";--> statement-breakpoint
-- Pre-auth rows have no owner and predate per-user data; `npm run db:seed`
-- repopulates the demo account right after this migration runs.
DELETE FROM "application_status_history";--> statement-breakpoint
...
CREATE INDEX "applications_user_status_interview_date_idx" ON "applications" USING btree ("user_id","status","interview_date");