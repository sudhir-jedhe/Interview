...
console.log("\n10. Hollow Square");
for (let i = 1; i <= n; i++) {
  if (i === 1 || i === n) console.log("* ".repeat(n).trim());
...
console.log("\n12. Right Arrow");
for (let i = 1; i <= n; i++) console.log("* ".repeat(i).trim());
for (let i = n - 1; i >= 1; i--) console.log("* ".repeat(i).trim());
...
console.log("\n18. Diamond Alphabet");
for (let i = 1; i <= n; i++)
  console.log(" ".repeat(n - i) + (alpha[i - 1] + " ").repeat(i).trimEnd());
for (let i = n - 1; i >= 1; i--)
  console.log(" ".repeat(n - i) + (alpha[i - 1] + " ").repeat(i).trimEnd());
