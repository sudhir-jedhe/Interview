...
### 12. Write a function which can return multiple values from a function
...
### 14. Show the usage of call, apply and bind with practical example
...
### 15. Show the usage of a function which can be used as a constructor
...
### 16. Show the procedure of creating an object using a factory function
...
### 17. Achieve prototypal inheritance using functions to create objects in JavaScript
...
### 18. Write a code to show the differences between the techniques, currying and partial application
...
### 19. Write a function to copy functions of an object to another object (mixin)
...
### 20. Show the usage Proxy for function
